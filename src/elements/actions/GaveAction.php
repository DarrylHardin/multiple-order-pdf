 ...
 * @since 3.0.0
 */
class GaveAction extends ElementAction
{
    // Properties
    // =========================================================================
    ...
    {
        return Craft::t('app', 'Mark Orders Gave to Customer and Generate PDF');
    }
    ...
    public function getTriggerHtml()
    {
        ...
        $message = "Changed through Gave to Employee and Generate PDF";
        $newStatus = 15;
        $deliveryMethod = "Gave to Employee";
        $js       = <<<EOD
(function()
{
